...
import { getCategoryName, getCircuitName, getSimulatorName } from '../../utils/combination/getters';
import { Button, Badge } from '../tremor/TremorComponents'; 

const CombinationForm = lazy(() => import('../CombinationForm')); 
