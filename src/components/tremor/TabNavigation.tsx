      ...
      {getSubtree({ asChild, children }, (children) => (
        <span
          className={cx(
            ...
            "group-has-[:not([data-active])]:group-hover:text-orange-200",
            "group-has-[:not([data-active])]:group-hover:border-orange-200",
            "group-has-[:not([data-active])]:dark:group-hover:text-gray-400",
            "group-has-[:not([data-active])]:dark:group-hover:border-gray-400",
