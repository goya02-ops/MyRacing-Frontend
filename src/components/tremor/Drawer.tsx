...
const DrawerTrigger = ({
  ...
  ref?: React.RefObject<React.ElementRef<
    typeof DrawerPrimitives.Trigger
  > | null>;
}) => {
  return (
...
const DrawerClose = ({
  ...
  ref?: React.RefObject<React.ElementRef<typeof DrawerPrimitives.Close> | null>;
}) => {
  return (
...
const DrawerOverlay = ({
  ...
  ref?: React.RefObject<React.ElementRef<
    typeof DrawerPrimitives.Overlay
  > | null>;
}) => {
  return (
...
const DrawerContent = ({
  ...
  ref?: React.RefObject<React.ElementRef<
    typeof DrawerPrimitives.Content
  > | null>;
}) => {
  return (
    <DrawerPortal>
...
const DrawerTitle = ({
  ...
  ref?: React.RefObject<React.ElementRef<typeof DrawerPrimitives.Title> | null>;
}) => (
...
const DrawerDescription = ({
  ...
  ref?: React.RefObject<React.ElementRef<
    typeof DrawerPrimitives.Description
  > | null>;
}) => {
  return (
