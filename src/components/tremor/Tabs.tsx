...
const TabsList = ({
  ...
  ref?: React.RefObject<React.ElementRef<typeof TabsPrimitives.List> | null>;
}) => (
  <TabsPrimitives.List
    ref={forwardedRef}
...
const TabsTrigger = ({
  ...
  ref?: React.RefObject<React.ElementRef<typeof TabsPrimitives.Trigger> | null>;
}) => {
...
const TabsContent = ({
  ...
  ref?: React.RefObject<React.ElementRef<typeof TabsPrimitives.Content> | null>;
}) => (
