...
export default function ResetPasswordPage() {
    ...
    return (
      <div className="flex items-center justify-center min-h-[60vh]">
        <div className="w-full max-w-md bg-gray-950/20 backdrop-blur-lg border border-gray-700/50 rounded-lg p-6">
          <h2 className="text-2xl font-bold text-red-400 mb-2">Token inválido</h2>
  ...
  if (success) {
    return (
      <div className="flex items-center justify-center min-h-[60vh]">
        <div className="w-full max-w-md bg-gray-950/20 backdrop-blur-lg border border-gray-700/50 rounded-lg p-6">
          <h2 className="text-2xl font-bold text-green-400 mb-2">Contraseña actualizada</h2>
          <p className="text-gray-400 mb-6">
  ...
  return (
    <div className="flex items-center justify-center min-h-[60vh]">
      <div className="w-full max-w-md bg-gray-950/20 backdrop-blur-lg border border-gray-700/50 rounded-lg p-6">
        <h2 className="text-2xl font-bold text-gray-100 mb-2">Nueva contraseña</h2>
        <p className="text-gray-400 mb-6">
